...
use frontend\models\TransducersSearch;
...
/**
 * TransducersController implements the CRUD actions for Transducers model.
 */
class TransducersController extends Controller
{
    /**
     * @inheritDoc
     */
    ...
    /**
     * Lists all Transducers models.
     *
     * @return string
     */
    public function actionIndex()
    {
        $searchModel = new TransducersSearch();
    ...
    /**
     * Displays a single Transducers model.
     * @param int $id ID
     * @return string
    ...
    /**
     * Creates a new Transducers model.
     * If creation is successful, the browser will be redirected to the 'view' page.
     * @return string|\yii\web\Response
     */
    public function actionCreate()
    {
        $model = new Transducers();
    ...
    /**
     * Updates an existing Transducers model.
    ...
    /**
     * Deletes an existing Transducers model.
    ...
    /**
     * Finds the Transducers model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param int $id ID
     * @return Transducers the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = Transducers::findOne(['id' => $id])) !== null) {
            return $model;
        }
