...
/**
 * TransducersSearch represents the model behind the search form of `frontend\models\Transducers`.
 */
class TransducersSearch extends Transducers
{
    /**
     * {@inheritdoc}
     */
