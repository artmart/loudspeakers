...
<table class="table table-sm align-middle driver_data">
<thead>
    <tr>
  ...
  display: block;
  width: 180px; float: left; color: #0065d8;"><?=$model->Brand;?></span> 
            <span style="white-space: nowrap;
  overflow: hidden;
  text-overflow: ellipsis;
  display: block;
  width: 130px; float: left; color: #0065d8"><?=$model->Model;?></span></h4>
            </a>
...
<tbody>
    <tr>
        <td class="size_type">
            <span data-highlight="size"><b><?=$model->Dnom_in;?></b>″</span> 
            <span data-highlight="type" style="white-space: nowrap;
  overflow: hidden;
  text-overflow: ellipsis;
  display: block;
  width: 180px; float: left;"><?=$model->Type;?></span>
        </td>
    </tr>
    <tr>
        <td class="symbol">
    ...
    <tr>
        ...
        <td class="value">
            <span data-highlight="blre"><b><?=round($model->BL, 2);?></b></span>
        </td>
    </tr>
    <tr>
        <td class="symbol">
